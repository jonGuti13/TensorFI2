...
bitFlipPositions = np.zeros((100, 32), dtype=int) #100 capas (not quantized) o 56 capas (quantized), 9 bitFlipPositions (ojo el MSB esta a la derecha) #56 capas para el modelo cuantizado
for file in files:
...
#files = glob.glob(carpetaPrediccionFI + "*.png")
#files.sort()
#bitFlipError = np.zeros((100, 32), dtype=int) #100 capas (not quantized) o 56 capas (quantized), 9 bitFlipPositions (ojo el MSB esta a la derecha)
#bitFlipErrorReduced = np.zeros((100, 32), dtype=int) #100 capas (not quantized) o 56 capas (quantized), 9 bitFlipPositions (ojo el MSB esta a la derecha)
#bitFlipErrorReduced2 = np.zeros((100, 32), dtype=int) #100 capas (not quantized) o 56 capas (quantized), 9 bitFlipPositions (ojo el MSB esta a la derecha)
#for file in files:
